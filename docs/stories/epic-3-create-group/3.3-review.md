...
- [x] งวดแรก = ท้าวแชร์ได้เงินเสมอ (ไม่ประมูล, แก้ไขไม่ได้)
- [x] สามารถแก้ไข scheduledDate ของแต่ละงวดได้
- [x] สามารถเลือกสมาชิก (assign) ให้งวดที่ 2 เป็นต้นไปได้ (optional)
...
- สร้างรายการงวด (Rounds) อัตโนมัติ ตามจำนวน maxMembers
  ...
  - งวดแรก scheduledDate = startDate, assign ให้ท้าวแชร์อัตโนมัติ
